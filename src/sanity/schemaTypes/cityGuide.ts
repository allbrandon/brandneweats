        ...
        defineField({
          ...
          of: [defineArrayMember({
            ...
            fields: [
              ...
              defineField({ name: "promoCode", title: "Discount code (optional)", type: "string",
                description: "Add this and an offer label to show the two-colour promo pill.", placeholder: "BRANDNEWEATSKLOOK" }),
              defineField({ name: "promoOffer", title: "Offer label (optional)", type: "string",
                description: "Shown beside the discount code in the promo pill.", placeholder: "15% off" }),
